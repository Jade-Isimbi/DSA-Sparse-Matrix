...
def main():
    try:
        ...
        matrix1 = SparseMatrix.load_from_file("/home/jade/sparse_matrix/sample_inputs/easy_sample_02_1.txt")
        matrix2 = SparseMatrix.load_from_file("/home/jade/sparse_matrix/sample_inputs/easy_sample_02_2.txt")
